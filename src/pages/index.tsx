  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Personal CRM - your intelligent assistant for tracking contacts, setting smart reminders, and noting down key insights from meetings and conversations. Revolutionize your networking today."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1585974738771-84483dd9f89f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxDUk18ZW58MHx8fHwxNjk1Mzk3MjkyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Personal CRM - your intelligent assistant for tracking contacts, setting smart reminders, and noting down key insights from meetings and conversations. Revolutionize your networking today.`}
            </Text>
            <Box
